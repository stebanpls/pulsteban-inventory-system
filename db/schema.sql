-- TALLER: DISEÑO DE LA BASE DE DATOS DEL PROYECTO INTEGRADOR
...
-- 2. Table: user (Unified for authentication and business logic)
CREATE TABLE user (
...
-- Insert an admin user with a hashed password ('admin')
...
-- 4. Table: materials (raw materials/supplies)
-- Includes foreign key supplier_id linking to suppliers
...
-- Includes foreign keys material_id and user_id
CREATE TABLE inventory_movements (
    id INT AUTO_INCREMENT PRIMARY KEY,
    material_id INT NOT NULL,
    user_id INT NOT NULL,
    movement_type VARCHAR(15) NOT NULL, -- e.g., 'Entry', 'Exit'
...
-- 7. Table: audit_log (For the Audit Module)
...
-- ====================================================================
-- SEED DATA (5 SAMPLE RECORDS FOR EACH MAIN TABLE)
-- ====================================================================
...
-- Insertion into: finished_products
...
-- Insertion into: inventory_movements
INSERT INTO inventory_movements (material_id, user_id, movement_type, quantity, notes) VALUES
(1, 2, 'Entrada', 50.00, 'Compra según Factura 405'), -- user_id 2 is 'bodeguero'
(3, 2, 'Entrada', 10.00, 'Reabastecimiento local'), -- user_id 2 is 'bodeguero'
(1, 1, 'Salida', 15.50, 'Despacho a lote de producción BOT-01 por admin'), -- user_id 1 is 'admin'
(2, 2, 'Salida', 20.00, 'Entrega de suelas a taller de armado'), -- user_id 2 is 'bodeguero'
(4, 1, 'Entrada', 5.00, 'Ingreso por caja menor por admin'); -- user_id 1 is 'admin'